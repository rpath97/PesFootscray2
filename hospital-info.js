...
//     // Focus first hospital info card (welcome)
//     const welcomeCard = document.querySelector('.hospital-info-card[data-type="welcome"]');
//     if (welcomeCard) {
//         // Set JAPIT focus
//         var JAPITObjForWIXPSvc = new CreateJAPITObjectForWIXPSvc();
//         JAPITObjForWIXPSvc.Cookie = 2041;
...
//     const card = document.querySelector('.hospital-info-card[data-type="welcome"]');
//     if (card) {
